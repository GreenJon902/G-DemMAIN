    ...
    return (
        <div className="bg-neutral-900">
            ...
            <div className="flex justify-center space-x-4 text-neutral-100">
                <TextLink color={TEXT_LINK_WHITE} className="font-medium" href="">Join Now!</TextLink>
                <TextLink color={TEXT_LINK_WHITE} className="font-medium" href="/rules">Rules</TextLink>
                <TextLink color={TEXT_LINK_WHITE} className="font-medium" href="">World Map</TextLink>
